...
$_['text_mail_description']       = 'Будьте в курсе обновлений и событий в opencart.';
...
$_['text_facebook']   		      = 'Официальный сайт <br> сборки';
$_['text_facebook_description']   = 'Посетите сайт сборки <br>Новости. Магазин. Форум. Центр загрузки';
$_['text_facebook_visit']         = 'Перейти на сайт';
$_['text_forum']    	 	     = 'Cообщество OpenCart';
$_['text_forum_description']      = 'Получи помощь от пользователей OpenCart<br> Самое дружное сообщество OpenCart';
$_['text_forum_visit']            = 'Перейти на форум';
$_['text_commercial']            = 'Коммерческая поддержка';
$_['text_commercial_description'] = 'Получите платную поддержку от специалистов OpenCart';
$_['text_commercial_visit']       = 'Получи коммерческую поддержку';
$_['text_price']   	              = 'Price';
...
// Button
$_['button_mail']                 = 'Присоединиться';
$_['button_setup']                = 'Set-up now';

// Error
$_['error_warning']               = 'Не забудьте удалить установочную директорию install   !';
